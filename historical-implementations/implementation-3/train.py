...
class Trainer:
    def __init__(self, model, criterion, optimizer, train_loader, val_loader, epochs, device, early_stopping_patience, batch_size):   
        # model parameters
        self.model = model
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            # convert shuffled iterator-list back to iterator
            ...
            self.historical_train_acc.append(train_accuracy)
        ...
        return self.best_model, self.historical_loss, self.historical_acc, self.historical_train_loss, self.historical_train_acc
